# Natural Beauty — Landing Page

Landing page Astro pour l'app "Natural Beauty" (AGH Data Agency Holding).
...
- Aucune icône dédiée n'a été fournie pour cette app : un logo simple (feuille) a été dessiné en SVG dans l'en-tête. Remplace-le si tu as une icône officielle.
