# Exam Assistant — Landing Page

Landing page Astro pour l'app "Exam Assistant / Study Helper" (AGH Data Agency Holding).
...
## Déployer sur Vercel
1. Pousse le contenu de ce dossier dans le sous-dossier prévu pour cette app sur le dépôt `Landing-pages` de l'entreprise.
